...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20 font-["Founders Grotesk X-Cond SmBd"]'>
        <div className="w-1/2 h-full flex flex-col justify-between font-['Founders Grotesk X-Cond SmBd']">
            <div className="heading">            
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-3'>Eye-</h1>
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-3'>Opening</h1>
            </div>
        ...
        <div className="w-1/2">
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-3'>Presentations</h1>
